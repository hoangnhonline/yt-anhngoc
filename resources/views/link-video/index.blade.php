...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      @endif      
      <a href="{{ route('link-video.create') }}" class="btn btn-info" style="margin-bottom:5px">Tạo mới</a>
            ...
            @if( $items->count() > 0 )
              ...
              <tr id="row-{{ $item->id }}">
                ...
                <td style="white-space:nowrap">               
                  <a href="{{ route( 'link-video.edit', [ 'id' => $item->id ]) }}" class="btn-sm btn btn-warning">Chỉnh sửa</a>                                   
                  <a onclick="return callDelete('{{ $item->title }}','{{ route( 'link-video.destroy', [ 'id' => $item->id ]) }}');" class="btn-sm btn btn-danger">Xóa</a>
                </td>              
              </tr> 
              @endforeach
            @else
