...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="<?php echo e(route('chu-de.update')); ?>" id="formData">
    <div class="row">
      <!-- left column -->
            ...
            <div class="box-body">
              <?php echo $__env->make('message', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                ...
                <div class="form-group">  
                  ...
                  <input type="text" class="form-control"  name="ten" id="ten" value="<?php echo e(old('ten', $detail->ten)); ?>">
                </div>                
            </div>
