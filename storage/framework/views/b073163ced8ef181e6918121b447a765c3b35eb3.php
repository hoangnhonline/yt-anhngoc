...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <?php endif; ?>      
      <a href="<?php echo e(route('link-video.create')); ?>" class="btn btn-info" style="margin-bottom:5px">Tạo mới</a>
      
       <div class="panel panel-default">        
        <div class="panel-body">
          <form class="form-inline" role="form" method="GET" action="<?php echo e(route('link-video.index')); ?>">                        
            ...
            <?php if( $items->count() > 0 ): ?>
              ...
              <tr id="row-<?php echo e($item->id); ?>">
                ...
                <td style="white-space:nowrap">               
                  <a href="<?php echo e(route( 'link-video.edit', [ 'id' => $item->id ])); ?>" class="btn-sm btn btn-warning">Chỉnh sửa</a>                                   
                  <a onclick="return callDelete('<?php echo e($item->title); ?>','<?php echo e(route( 'link-video.destroy', [ 'id' => $item->id ])); ?>');" class="btn-sm btn btn-danger">Xóa</a>
                </td>              
              </tr> 
              <?php endforeach; ?>
            <?php else: ?>
